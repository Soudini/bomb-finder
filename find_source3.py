...
import multiprocess_local_search3 as ls3
import numpy as np
import bati
...
#on utilise ls3 qui correspond au basic local search
ls_results = ls3.batch_local_search(SOURCE_PATH, starting_points, m_heur)
